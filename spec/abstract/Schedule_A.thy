...
text \<open>
  ...
  @{const switch_to_idle_thread} and do nothing.
\<close>
...
lemmas schedule_def_all =
  schedule_det_ext_ext_def schedule_unit_def pre_choose_thread_unit_def choose_thread_unit_def allActiveTCBs_def
